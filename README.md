...
Телеграм-бот для исследования космоса с помощью API NASA. Бот предоставляет доступ к различным космическим данным, изображениям и информации о космических объектах.
...
- 🌞 **Солнечная система**: Подробная информация и изображения всех планет Солнечной системы
- ✨ **Экзопланеты**: Каталог известных экзопланет с описаниями и визуализациями
